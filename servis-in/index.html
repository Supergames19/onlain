    ...
    <div class="main-wrapper">
        ...
        <div class="controls-panel">
            <div class="control-group">
                <label>📷 Ganti Foto Unit</label>
                <input type="file" id="image-upload" accept="image/*">
            </div>
            <div class="control-group" style="margin-top: 10px;">
                <label>💾 Simpan Dokumen</label>
        ...
        <div id="service-editor">
            <div id="notification-container">
                ...
                <div class="device-img-wrapper">
                    <img id="device-photo" src="https://via.placeholder.com/400x250/e2e8f0/94a3b8?text=Foto+Unit+Disini" alt="Foto Unit">
                </div>
