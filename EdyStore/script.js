const AuraStore = (function() {
    ...
    function saveHtml() {
         ...
         try {
             ...
             const mainScriptTagInClone = htmlClone.querySelector('script[src="../script.js"]');
  ...
  `;
                 ...
                 console.warn("- Could not find <script src='../script.js'> tag in clone to embed content.");
    ...
    async function init() {
        console.log("Store v3.5.0 Initializing...");
  ...
  document.addEventListener('DOMContentLoaded', () => {
    AuraStore.runInit().catch(error => {
        console.error("Unhandled Error during Store Initialization:", error);
